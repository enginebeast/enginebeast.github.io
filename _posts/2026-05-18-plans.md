...
Because of that, I started researching autonomous driving technologies and related materials without a clear plan, hoping that they could somehow be applied to my project. Ironically, this approach led me to study topics that were either far too advanced for my current level or unnecessary for my actual goal.
미니 자율주행 자동차를 만드는 단계에서 나는 내가 어디로 나아가야 할 지 방향을 잡지 못하기 시작했다.
